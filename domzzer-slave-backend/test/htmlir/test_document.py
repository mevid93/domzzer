...
class TestHTMLDocument(unittest.TestCase):
    ...
    def test_convert_works(self):
        ...
        expected_str += "<head profile=\"http://localhost:3002/profiles/core\" tabindex=\"\" "
        expected_str += "accesskey=\"m\" title=\"Nice attribute title\" autocapitalize=\"off\">\n"
        expected_str += "</head>\n"
        expected_str += "<body autocapitalize=\"characters\">\n"
        expected_str += "\n"
        expected_str += "</body>"
