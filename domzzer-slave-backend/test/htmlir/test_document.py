...
class TestHTMLDocument(unittest.TestCase):
    ...
    def test_convert_works(self):
        ...
        expected_str += "<head profile=\"http://localhost:3002/profiles/core\" tabindex=\"-1\" "
        expected_str += "translate=\"yes\" title=\"Lirum larum attribute title\" accesskey=\"i\">\n"
        expected_str += "</head>\n"
        expected_str += "<body  title=\"123132132132312\">\n"
